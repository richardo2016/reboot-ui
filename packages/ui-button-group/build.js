...
function buildLib () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-button-group -- lib >>]build finished!')
      })
}
...
function buildDist () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-button-group -- dist >>]build finished!')
      })
}
...
function buildEsm () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-button-group -- esm >>]build finished!')
      })
}
