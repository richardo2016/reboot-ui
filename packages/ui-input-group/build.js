...
function buildLib () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-input-group -- lib >>]build finished!')
      })
}
...
function buildDist () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-input-group -- dist >>]build finished!')
      })
}
...
function buildEsm () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-input-group -- esm >>]build finished!')
      })
}
