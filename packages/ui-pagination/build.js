...
function buildLib () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-pagination -- lib >>]build finished!')
      })
}
...
function buildDist () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-pagination -- dist >>]build finished!')
      })
}
...
function buildEsm () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-pagination -- esm >>]build finished!')
      })
}
