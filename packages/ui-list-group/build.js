...
function buildLib () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-list-group -- lib >>]build finished!')
      })
}
...
function buildDist () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-list-group -- dist >>]build finished!')
      })
}
...
function buildEsm () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-list-group -- esm >>]build finished!')
      })
}
