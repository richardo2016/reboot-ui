...
function buildLib () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-container -- lib >>]build finished!')
      })
}
...
function buildDist () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-container -- dist >>]build finished!')
      })
}
...
function buildEsm () {
  ...
  rollup.rollup(rollupConfig)
      ...
      .then(() => {
          console.log('[ui-container -- esm >>]build finished!')
      })
}
